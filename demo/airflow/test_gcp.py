...
default_args = {
    ...
    'start_date': datetime(2019, 2, 26, 19, 15),  # CHANGEME!
...
dag = DAG(
    ...
    description='test_copy_cloudsql_to_bigquery',
...
def create_bigquery_schema_from_kv(**kwargs):
    os.system("whoami")
    os.system("gsutil cp  gs://tmp-mpp-bucket-2/cloudsql/export/SAMPLE_TABLE_2_20190227_schema_raw .")
    """
...
for table_config in get_tables():
    ...
    start_task >> bq_schema_task >> end_task
